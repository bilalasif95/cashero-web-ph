...
money_safe_P1: "Yes. Your money is protected using multi-party computation (MPC) and hardware isolation with Intel SGX enclaves. It sounds complex and it is, on purpose. These security layers ensure your money and information is safe and protected.",
    ...
    Learn_more_savings_P11: "Por que considerar uma conta com rendimento em dólar em vez de outro tipo de conta?",
    Learn_more_savings_P12: "Se desejar ter acesso ao seu dinheiro regularmente ou mais rápido, então uma conta com rendimento em dólar é definitivamente a opção certa para você, especialmente uma conta online. Com uma conta online, você tem acesso seguro 24 horas por dia, 7 dias por semana, aos seus fundos e, normalmente, paga tarifas menores do que em bancos tradicionais.",
...
multi_currency_Learn_P17: "Multi-currency accounts might be useful for you if:",
    ...
    multi_currency_Learn_P60: "Com uma quantidade enorme de provedores oferecendo contas multimoeda, você pode ficar confuso ou sufocado. Para decidir sobre qual conta multimoeda é a certa para você, comece pesquisando as últimas ofertas e veja quais recursos são disponibilizados. Por exemplo, pode ser essencial para você ter acesso aos seus fundos por meio de um app ou poder contatar um agente de atendimento ao cliente 24 horas, 7 dias por semana. Você também pode até mesmo querer gerenciar seu dinheiro sem precisar ir até uma agência bancária, seja por qual for o motivo, e manter tudo digital. Esses pré-requisitos específicos devem ser levados em conta ao escolher uma conta multimoeda para assegurar que suas necessidades sejam atendidas.",
    multi_currency_Learn_P61: "Se for proprietário de uma empresa, você provavelmente terá interesse em obter as taxas mais favoráveis para serviços vinculados, como serviços de viagem no exterior, saques a descoberto e poupança. Dependendo dos requisitos e das necessidades de transações do seu negócio, é primordial analisar qual conta multimoeda será a mais adequada para eles. Assim, você também poderá calcular quanto uma transação típica custará e ver se isso é vantajoso para você.",
