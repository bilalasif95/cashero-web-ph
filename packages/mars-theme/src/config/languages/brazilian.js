export const brazilian = {
    ...
    LEGAL_AUTHORITIES_li2: "We believe that the disclosure is necessary to prevent physical harm or financial loss;",
    LEGAL_AUTHORITIES_li3: "Disclosure is necessary to report suspected illegal activity;",
    LEGAL_AUTHORITIES_li4: "Disclosure is necessary to investigate violations of this Privacy Policy or any of our agreements with you.",
    INTERNATIONAL_TRANSFERS: "INTERNATIONAL TRANSFERS OF PERSONAL INFORMATION",
    INTERNATIONAL_TRANSFERS_P1: "We store and process your Personal Information in data centers around the world, wherever Company facilities or service providers are located. As such, we may transfer your Personal Information between such data centers. Such transfers are undertaken following our legal and regulatory obligations and are performed only via protected channels.",
    CIRCUMSTANCES: "OTHER CIRCUMSTANCES FOR DISCLOSURE OF PERSONAL INFORMATION",
    CIRCUMSTANCES_P1: "We also can disclose your Personal Information in the following circumstances:",
    ...
    CIRCUMSTANCES_li3: "if the sharing of Personal Information is necessary for the protection of our rights and property, or rights and property of the above listed current or future parent companies, affiliates, subsidiaries, and with other companies under common control or ownership with us or our offices.",
    EXTERNAL_WEBSITES: "EXTERNAL WEBSITES",
    ...
    main_features_B4: "Instant payments:",
    ...
    Learn_more_savings_P14: "How safe are high-yield savings accounts?",
    Learn_more_savings_P15: "High-yield savings accounts are safe when operated by  FDIC (Federal Deposit Insurance Corporation). These accounts are insured by the FDIC up to a max sum allowed by law — $250,000 per depositor at the time of this article. So what does this mean and how do you benefit from it? Putting it simply,  the government ensures your funds are safe and accessible even if the financial institution fails. All of these factors combined make high yield savings accounts the perfect option for individuals wishing to save money for:",
    Learn_more_savings_P16: "Short-term savings goals",
    Learn_more_savings_P17: "Large expenses",
    Learn_more_savings_P18: "Emergencies",
    ...
    Learn_more_savings_P31_P1: "As a saver, you may be limited to six withdrawals per month from your savings account due to Reg D or Regulation D. The only exception is when you withdraw in-person at a bank or from an ATM.  With Cashero there are no limits to withdrawals on your money.",
    ...
    multi_currency_safe: "Is my money safe",
    multi_currency_safe_P: "Yes. Your money is protected using multi-party computation (MPC) and hardware isolation with Intel SGX enclaves. It sounds complex and it is, on purpose. These security layers ensure your money is safe and protected.",
