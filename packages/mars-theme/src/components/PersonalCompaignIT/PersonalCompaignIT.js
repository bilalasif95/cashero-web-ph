...
const PersonalCompaignIT = ({ i18n }) => {
  ...
  const handleChange = (e) => {
    ...
    const results = searchResults.filter(
      (country) =>
        country.name_it.toLowerCase().includes(searchTerm.toLocaleLowerCase()) ||
  ...
  return (
    <>
      <Head>
        <html lang="it-IT" />
        <link rel="alternate" hreflang="it-IT" href="https://www.cashero.com/it/" />
        <link rel="alternate" hreflang="x-default" href="https://www.cashero.com/it/" />
              ...
              <div className="compaignForm">
                ...
                <div className="compaignFormCont">
                  <div className="form-group">
                    <input id="ContainerElementID" ref={fullName} type="text" className="form-control" autoFocus={innerWidth <= 540 ? false : true} value={name} onChange={e => setName(e.target.value)} placeholder="Inserisci nome" />
                  </div>
                  <div className="form-group">
                    <input type="email" className="form-control" value={email} onChange={e => setEmail(e.target.value)} placeholder="Inserisci e-mail" />
                  </div>
                      ...
                      <div className="selectCountry">
                        <Dropdown isOpen={dropdownOpen} toggle={toggle}>
                          <DropdownToggle caret className="border-bottom-0">
                            <input type="text" placeholder="Codice" readOnly value={code} />
                          </DropdownToggle>
                          <DropdownMenu>
                            <DropdownItem header>
                              <>
      ...
      <CompaignNoEffort lang="it" focus={focus} />
      <div className="container">
        <Savings lang="it" focus={focus} />
      </div>
      {openSuccessModal && <CompaignThanksModal open={openSuccessModal} handleClose={thanksModalClose} lang="it" />}
      <CampaignTabs />
...
export default withTranslation()(PersonalCompaignIT);
