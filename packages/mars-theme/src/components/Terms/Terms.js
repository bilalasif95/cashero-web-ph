				...
				<div className="row">
					<div className="col-md-8 offset-md-2">
						<div className="terms_titles">
							...
							<p>These Terms and Conditions (hereinafter the “Terms”) is a binding legal agreement between you, whether personally or on behalf of an entity (“you“) and Cashero Financial OÜ (hereinafter “Company”, “Our”, “Us”, “We”, “Cashero") having its registered address at Keemia 4, Tallinn, Estonia 10616, concerning your access to and use of the <a href={websiteLink} target="_blank" rel="noopener noreferrer">www.cashero.com</a> website as well as any other media form, media channel, mobile website or mobile application related, linked, or service provided by Cashero, or otherwise connected thereto (collectively, the “Site”). Both, individual (private persons) and business (corporate and institutions) customers are subjected to this agreement. These Terms are made to ensure quality and safety of use on the Site. You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
