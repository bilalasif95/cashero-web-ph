...
const PersonalCompaignFR = ({ i18n }) => {
  ...
  const handleChange = (e) => {
    ...
    const results = searchResults.filter(
      (country) =>
        country.name_fr.toLowerCase().includes(searchTerm.toLocaleLowerCase()) ||
  ...
  return (
    <>
              ...
              <div className="compaignForm">
                ...
                <div className="compaignFormCont">
                  <div className="form-group">
                    <input id="ContainerElementID" ref={fullName} type="text" className="form-control" autoFocus={innerWidth <= 540 ? false : true} value={name} onChange={e => setName(e.target.value)} placeholder="Saisissez votre nom" />
                  </div>
                  <div className="form-group">
                    <input type="email" className="form-control" value={email} onChange={e => setEmail(e.target.value)} placeholder="Saisissez votre adresse e-mail" />
                  </div>
      ...
      <CompaignNoEffort lang="fr" focus={focus} />
      <div className="container">
        <Savings lang="fr" focus={focus} />
      </div>
      {openSuccessModal && <CompaignThanksModal open={openSuccessModal} handleClose={thanksModalClose} lang="fr" />}
      <CampaignTabs />
