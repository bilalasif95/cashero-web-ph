          ...
          <div className="row">
            <div className="col-md-7">
              <div className="PersonalCont">
                <h1>
                  Transfer Money{" "}
                  <span className="br-block-with-no-display"></span> Abroad{" "}
                </h1>
                <p className="bannerPara">
                  Global transfers that stretch your money further into the
                  hands of where it needs to be.
                </p>
                <TextfieldBanner />
        ...
        <div className="row">
          <div className="col-md -12">
            <ul className="PersonalCompanyList list-unstyled">
              <li>
                <img alt="Globe Dollar" src={GlobeDollar} />
                Send money worldwide
              </li>
              <li>
                <img alt="Dollar list" src={Dollarlist} />
                No hidden fees. No minimum balance required
              </li>
              <li>
              ...
              <li>
                <img alt="list Home" src={listHome} />
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12  smBox3">
              <Fade triggerOnce direction="right">
                <div className="GetStartedBox3 w-100">
                  ...
                  <h3>
                    Send money to a Cashero user and have them withdraw the
                    funds.
                  </h3>
                </div>
              </Fade>
          ...
          <div className="row">
            <div className="offset-md-1 col-md-10">
              <div className="MultistepsCont">
                <p>
                  Ready to send money hassle-free? Cashero’s global payment
                  solution is here for you and for what matters most.
                </p>
