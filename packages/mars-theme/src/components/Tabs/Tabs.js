									...
									<AccordionDetails>
										<Typography>
											<div className="expandTypo">
												...
												<h3 className="blackhead"><a href="https://www.cashero.com/blog/what-is-a-high-yield-savings-account/" target="_blank" rel="noopener noreferrer">{i18n.t("Learn_more_savings_P4")}</a> {i18n.t("Learn_more_savings_P4_1")}</h3>
