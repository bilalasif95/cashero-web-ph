					...
					<TabPanel value={value} index={0}>
						<div className="CollapseToggle">
							...
							>
								...
								<AccordionDetails>
									<Typography>
										<h4 className="FaqText">HIGH YIELD SAVINGS: Cashero users receive inflation beating interest rates of 2%-5% APY.</h4>
										<h4 className="FaqText">MULTI CURRENCY WALLETS: No minimum balance or maintenance fees. Cashero users can reduce currency fluctuation risk by holding balances in USD, GBP and EUR.</h4>
										<h4 className="FaqText">CURRENCY CONVERSION: Users can instantly exchange between USD, EUR and GBP.</h4>
										<h4 className="FaqText">INSTANT PAYMENTS: Users can send, request and instantly receive money from users worldwide.</h4>
										<h4 className="FaqText">BUSINESS: Businesses can send, request and receive money from customers worldwide.</h4>
										<h4 className="FaqText">CHARITY: Charities can sign up to Cashero to receive donations. Charities can use their Cashero link to request donations via Cashero.</h4>
										<h4 className="FaqText">REWARDS: Users earn rewards for referring people to Cashero.</h4>
									</Typography>
								</AccordionDetails>
							</Accordion>
							<Accordion
							...
							>
								...
								<AccordionDetails>
									<Typography>
										<h4 className="FaqText">Cashero will be released after the application undergoes a thorough security audit by Trail of Bits in February 2021.</h4>
									</Typography>
								</AccordionDetails>
							</Accordion>
							<Accordion
							...
							>
								...
								<AccordionDetails>
									<Typography>
										...
										<span><a href="mailto:info@cashero.com">info@cashero.com</a></span>
									</Typography>
								</AccordionDetails>
							</Accordion>
						</div>
									...
									<AccordionDetails>
										<Typography>
											<div className="expandTypo">
												...
												<h2 className="blackhead">Why consider a high APY savings account instead of another account type? </h2>
