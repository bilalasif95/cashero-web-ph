...
export function CurrencyAccounts() {
  ...
  const calculateBRL = (value, label) => {
    if (label === "US Dollar - USD") {
      const multi = bigDecimal.multiply(50.0, value);
      const final = limit(multi);
      return final;
    } else if (label === "EU Euro - EUR") {
      const multi = bigDecimal.multiply(60.0, value);
      const final = limit(multi);
      return final;
    } else {
      const multi = bigDecimal.multiply(70.0, value);
      const final = limit(multi);
      return final;
    }
  };
          ...
          <div className="row align-items-center">
            <div className="col-md-7">
              <div className="PersonalCont">
                <h1>
                  Multi-Currency{" "}
                  <span className="br-block-with-no-display"></span> Savings
                  Account
                </h1>
                <p className="bannerPara">
                  Go from zero to hero. Make your money borderless and keep it
                  safe from currency fluctuations.
                </p>
                <TextfieldBanner />
                ...
                <div className="GraphCont">
                  ...
                  <p className="mt-3">
                    ...
                    {flagcurrencygbp === "US Dollar - USD"
                      ? calculateBRL(baseCurrencyUSDValue, "US Dollar - USD")
                      : flagcurrencygbp === "EU Euro - EUR"
                      ? calculateBRL(baseCurrencyEURValue, "EU Euro - EUR")
                      : calculateBRL(baseCurrencyGBPValue, "")}
                  </p>
        ...
        <div className="row">
          <div className="col-md -12">
            <ul className="PersonalCompanyList2 list-unstyled">
              <li>
                <img alt="one Wallet" src={oneWallet} />
                One wallet, multiple currencies
              </li>
              <li>
                <img alt="List Phone" src={ListPhone} />
                No monthly fees. No minimum balance required
              </li>
              <li>
                <img alt="Draw" src={Draw} />
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12  smBox2">
              <div className="GetStartedBox2 w-100">
                ...
                />
                <h3>
                  Add funds to your Multi-Currency Account and hold USD, GBP or
                  EUR.
                </h3>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12  smBox3">
              <Fade triggerOnce direction="right">
                <div className="GetStartedBox3 w-100">
                  ...
                  />
                  <h3>
                    Earn interest and safeguard your money from currency
                    devaluation.
                  </h3>
                </div>
              </Fade>
            ...
            <div className="offset-md-1 col-md-10">
              <div className="MultistepsCont">
                ...
                <button onClick={appModalOpen} className="LinkBtn">
                  Get Early Access{" "}
                  <img alt="Arrow" className="ArrowBtn" src={Arrow1} />
                </button>
              </div>
            </div>
          </div>
