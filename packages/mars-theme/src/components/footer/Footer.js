		...
		<>
			...
			<div className="container">
				...
				<div className="Footer">
					{/* <p>
						Romans 828 (UK) Limited trading as "Cashero" is a limited company registered in England and Wales with the registered company number 12783127 and its registered address at 33 St James's Square, London, SW1Y 4JS, United Kingdom. Cashero uses Wyre Payments, Inc. a registered money service business (NMLS ID: 1574869) and Circle UK Trading Limited an E-Money Issuer authorised by the Financial Conduct Authority (license No. 900480).
					</p> */}
					<div className="row">
