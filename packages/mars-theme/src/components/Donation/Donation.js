          ...
          <div className="row">
            <div className="col-md-7">
              <div className="PersonalCont">
                <h1>
                  Make an Impact,{" "}
                  <span className="br-block-with-no-display"></span> Watch Your
                  Money <span className="br-block-with-no-display"></span> Go
                  Further{" "}
                </h1>
                <p className="bannerPara">
                  Select a charity, donate, and they’ll receive every penny of
                  your donations.
                </p>
                <TextfieldBanner />
        ...
        <div className="row">
          <div className="col-md -12">
            <ul className="PersonalCompanyList3 list-unstyled">
              <li>
                <img alt="heart Dollar" src={heartDollar} />
                Become listed as a charity
              </li>
              <li>
                <img alt="donate Dollar" src={donateDollar} />
                Receive donations directly at any time
              </li>
              <li>
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12  smBox2">
              <div className="GetStartedBox2 w-100">
                ...
                <h3>Tap Donate and select a charity</h3>
              </div>
            </div>
              ...
              <Fade triggerOnce direction="right">
                <div className="GetStartedBox3 w-100">
                  <img
                    ...
                    src={pricewallet}
                  />
                  <h3>Make donations to make a difference!</h3>
                </div>
              </Fade>
            </div>
          </div>
          <div className="row">
            <div className="offset-md-1 col-md-10">
              <div className="MultistepsCont">
                <p>
                  Ready to donate? Head over to the Cashero app, the rest is
                  simple.
                </p>
