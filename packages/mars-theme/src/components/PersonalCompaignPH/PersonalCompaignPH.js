...
const PersonalCompaignPH = ({ i18n }) => {
  ...
  return (
    <>
      <Head>
        <html lang="tl-PH" />
        <link rel="alternate" hreflang="tl-PH" href="https://www.cashero.com/ph/" />
        <link rel="alternate" hreflang="x-default" href="https://www.cashero.com/ph/" />
              ...
              <div className="compaignForm">
                ...
                <div className="compaignFormCont">
                  <div className="form-group">
                    <input id="ContainerElementID" ref={fullName} type="text" className="form-control" autoFocus={innerWidth <= 540 ? false : true} value={name} onChange={e => setName(e.target.value)} placeholder="Ilagay ang Pangalan" />
                  </div>
                  <div className="form-group">
                    <input type="email" className="form-control" value={email} onChange={e => setEmail(e.target.value)} placeholder="Ilagay ang Email" />
                  </div>
      ...
      <CompaignNoEffort lang="ph" focus={focus} />
      <div className="container">
        <Savings lang="ph" focus={focus} />
      </div>
      {openSuccessModal && <CompaignThanksModal open={openSuccessModal} handleClose={thanksModalClose} lang="ph" />}
      <CampaignTabs />
...
export default withTranslation()(PersonalCompaignPH);
