...
const PersonalCompaignES = ({ i18n }) => {
  ...
  const handleChange = (e) => {
    ...
    const results = searchResults.filter(
      (country) =>
        country.name_es.toLowerCase().includes(searchTerm.toLocaleLowerCase()) ||
  ...
  return (
    <>
      <Head>
        <html lang="es-ES" />
        <link rel="alternate" hreflang="es-ES" href="https://www.cashero.com/es/" />
        <link rel="alternate" hreflang="x-default" href="https://www.cashero.com/es/" />
              ...
              <div className="compaignForm">
                ...
                <div className="compaignFormCont">
                  <div className="form-group">
                    <input id="ContainerElementID" ref={fullName} type="text" className="form-control" autoFocus={innerWidth <= 540 ? false : true} value={name} onChange={e => setName(e.target.value)} placeholder="Introducir nombre" />
                  </div>
                  <div className="form-group">
                    <input type="email" className="form-control" value={email} onChange={e => setEmail(e.target.value)} placeholder="Introducir correo electrónico" />
                  </div>
                      ...
                      <div className="selectCountry">
                        <Dropdown isOpen={dropdownOpen} toggle={toggle}>
                          <DropdownToggle caret className="border-bottom-0">
                            <input type="text" placeholder="Código" readOnly value={code} />
                          </DropdownToggle>
                          <DropdownMenu>
                            <DropdownItem header>
                              <>
      ...
      <CompaignNoEffort lang="es" focus={focus} />
      <div className="container">
        <Savings lang="es" focus={focus} />
      </div>
      {openSuccessModal && <CompaignThanksModal open={openSuccessModal} handleClose={thanksModalClose} lang="es" />}
      <CampaignTabs />
...
export default withTranslation()(PersonalCompaignES);
