            ...
            <div className="col-md-6">
              <div className="PersonalCont">
                ...
                <p className="bannerPara">
                  Spread your story to the world as one of our listed charities,
                  and harness the power of free fundraising. You'll receive 100%
                  of all donations.
                </p>
                <TextfieldBanner />
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12  smBox2">
              <div className="GetStartedBox2 w-100">
                ...
                <h3>Apply to become a listed charity.</h3>
              </div>
            </div>
              ...
              <Fade triggerOnce direction="right">
                <div className="GetStartedBox3 w-100">
                  <img
                    ...
                    src={StepsWallet}
                  />
                  <h3>Receive donations and make a difference!</h3>
                </div>
              </Fade>
            </div>
          </div>
