          ...
          <div className="row">
            <div className="col-md-7">
              <div className="PersonalCont">
                <h1>
                  High-Yield <span className="br-block-with-no-display"></span>{" "}
                  Savings Account
                </h1>
                <p className="bannerPara">
                  Make your money do the work. Earn up to 5% APY on your
                  hard-earned cash, paid out daily.
                </p>
                <TextfieldBanner />
        ...
        <div className="row">
          <div className="col-md -12">
            <ul className="PersonalCompanyList list-unstyled">
              <li>
                <img alt="High Dollar" src={HighDollar} />
                Inflation-beating 5% APY
              </li>
              <li>
                <img alt="list Graph" src={listGraph} />
                Interest paid out daily
              </li>
              <li>
                <img alt="Draw" src={Draw} />
                Deposit or withdraw your money at any time
              </li>
              <li>
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12  smBox3">
              <Fade triggerOnce direction="right">
                <div className="GetStartedBox3 w-100">
                  ...
                  <h3>Earn up to 5% APY. Yep, that simple.</h3>
                </div>
              </Fade>
            </div>
          </div>
          <div className="row">
            <div className="offset-md-1 col-md-10">
              <div className="MultistepsCont">
                <p>
                  Ready to earn more? Growing your wealth is easy with Cashero's
