...
const Privacy = ({ i18n }) => {
  return (
    <>
      <Head>
        <link rel="canonical" href="https://www.cashero.com/br/privacy-policy/" />
        <link rel="alternate" hreflang="pt-BR" href="https://www.cashero.com/br/privacy-policy/" />
        <link rel="alternate" hreflang="x-default" href="https://www.cashero.com/br/privacy-policy/" />
      </Head>
          ...
          <div className="row">
            <div className="col-md-8 offset-md-2">
              ...
              <div className="terms_titles">
                ...
                <ul className="condition-list">
                  <li>{i18n.t("PRIVACY_POLICY_P5")}</li>
              ...
              <div className="terms_titles">
                ...
                <ul className="condition-list">
                  <li>{i18n.t("PRIVACY_POLICY_P21")}</li>
              ...
              <div className="terms_titles">
                ...
                <ul className="condition-list">
                  <li>{i18n.t("PRIVACY_POLICY_P33")}</li>
              ...
              <div className="terms_titles">
                ...
                <p>{i18n.t("EXTERNAL_WEBSITES_P1")}</p>
              </div>
              <div className="terms_titles">
                ...
                <p>{i18n.t("RIGHTS_REGARDING_P8")}</p>
              </div>
              <div className="terms_titles">
              ...
              <div className="terms_titles">
                ...
                <p>{i18n.t("RETENTION_UPDATES_P1")}</p>
              </div>
            </div>
          </div>
        </div>
