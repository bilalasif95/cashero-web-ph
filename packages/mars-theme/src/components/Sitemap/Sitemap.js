          ...
          <div className="row">
            <div className="col-md-12">
              <div className="bannerCont">
                ...
                <ul className="sitemap-list">
                  <li>
                    <Link link="/donation">Donate</Link>
                  </li>
                  <li>
                    <Link link="/become-listed-charity">
                      Become a Listed Charity
                    </Link>
                  </li>
                </ul>
                <h6 className="sitemap-head">
                  <Link link="/company">Company</Link>
                </h6>
                <h6 className="sitemap-head">
                  <Link link="/contact-us">Help</Link>
                </h6>
                <h6 className="sitemap-head">
                  <Link link="/terms">Terms</Link>
                </h6>
                <h6 className="sitemap-head">
                  <Link link="/giveaway">Giveaway</Link>
                </h6>
                <h6 className="sitemap-head">
