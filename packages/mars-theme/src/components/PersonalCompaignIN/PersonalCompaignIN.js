          ...
          <div className="row">
            ...
            <div className="col-md-5">
              <div className="compaignForm">
                ...
                <p className="text-center">{i18n.t("Compaign_Launch_1")}<span className="br-block"></span>{i18n.t("Compaign_Launch_2")} India.<span className="br-block"></span>{i18n.t("Compaign_Launch_3")}</p>
