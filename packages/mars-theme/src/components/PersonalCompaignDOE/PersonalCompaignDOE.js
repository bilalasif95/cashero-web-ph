...
const PersonalCompaignDOE = ({ i18n }) => {
  ...
  return (
    <>
      <Head>
        <html lang="pt-BR" />
        <link rel="alternate" hreflang="pt-BR" href="https://www.cashero.com/br-doe/" />
        <link rel="alternate" hreflang="x-default" href="https://www.cashero.com/br-doe/" />
          ...
          <div className="row">
            <div className="col-md-7">
              <div className="PersonalCont">
                ...
                <p className="bannerPara font-medium"></p>
              ...
              <div className="compaignForm">
                ...
                <div className="compaignFormCont">
                  <div className="form-group">
                    <input id="ContainerElementID" ref={fullName} type="text" className="form-control" autoFocus={innerWidth <= 540 ? false : true} value={name} onChange={e => setName(e.target.value)} placeholder="Introduzir nome" />
                  </div>
                  <div className="form-group">
                    <input type="email" className="form-control" value={email} onChange={e => setEmail(e.target.value)} placeholder="Introduzir email" />
                  </div>
