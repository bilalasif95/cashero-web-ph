...
const PersonalCompaignPT = ({ i18n }) => {
  ...
  const handleChange = (e) => {
    ...
    const results = searchResults.filter(
      (country) =>
        country.name_pt.toLowerCase().includes(searchTerm.toLocaleLowerCase()) ||
  ...
  return (
    <>
            ...
            <div className="col-md-5">
              <div className="compaignForm">
                ...
                <div className="compaignFormCont">
                  ...
                  <div className="form-group">
                    <input type="email" className="form-control" value={email} onChange={e => setEmail(e.target.value)} placeholder="Introduzir e-mail" />
                  </div>
      ...
      <CompaignNoEffort lang="pt" focus={focus} />
      <div className="container">
        <Savings lang="pt" focus={focus} />
      </div>
