          ...
          <div className="row">
            <div className="col-md-7">
              <div className="PersonalCont">
                <h1>
                  Instant Money{" "}
                  <span className="br-block-with-no-display"></span> Transfer{" "}
                </h1>
                <p className="bannerPara">
                  Send, request and receive payments in a flash. Pay and get
                  paid, we make it easy.
                </p>
                <TextfieldBanner />
        ...
        <div className="row">
          <div className="col-md -12">
            <ul className="PersonalCompanyList list-unstyled">
              <li>
                <img alt="wallet Down" src={walletDown} />
                Send, request and receive payments instantly
              </li>
              <li>
                <img alt="Instant" src={Instant} />
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12  smBox3">
              <Fade triggerOnce direction="right">
                <div className="GetStartedBox3 w-100">
                  ...
                  <h3>Send, request and receive payments in an instant.</h3>
                </div>
              </Fade>
            </div>
          </div>
          <div className="row">
            <div className="offset-md-1 col-md-10">
              <div className="MultistepsCont">
                <p>
                  Ready to make an instant money transfer? Cashero’s got you.{" "}
                </p>
