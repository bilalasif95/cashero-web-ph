					...
					<div className="row">
						<div className="col-md-7">
							<div className="PersonalCont">
								...
								<p className="draw-banner-text">Get early access to the Cashero app and earn a chance to win $1,000 every 3 days! <span className="br-block"></span> <Link link="/Giveaway"> s </Link> apply. </p>
							</div>
						</div>
