...
const PersonalCompaignZA = ({ i18n }) => {
  ...
  return (
    <>
      <Head>
        <link rel="alternate" hreflang="en-ZA" href="https://www.cashero.com/za/" />
        <link rel="alternate" hreflang="x-default" href="https://www.cashero.com/za/" />
          ...
          <div className="row">
            ...
            <div className="col-md-5">
              <div className="compaignForm">
                ...
                <p className="text-center">{i18n.t("Compaign_Launch_1")}<span className="br-block"></span>{i18n.t("Compaign_Launch_2")} South Africa.<span className="br-block"></span>{i18n.t("Compaign_Launch_3")}</p>
      ...
      {openSuccessModal && <CompaignThanksModal open={openSuccessModal} handleClose={thanksModalClose} lang="za" />}
      <CampaignTabs />
      <CampaignSignup />
    </>
  );
...
export default withTranslation()(PersonalCompaignZA);
