...
const PersonalCompaignID = ({ i18n }) => {
  ...
  const handleChange = (e) => {
    ...
    const results = searchResults.filter(
      (country) =>
        country.name_id.toLowerCase().includes(searchTerm.toLocaleLowerCase()) ||
  ...
  return (
    <>
      <Head>
        <link rel="alternate" hreflang="id-ID" href="https://www.cashero.com/id/" />
        <link rel="alternate" hreflang="x-default" href="https://www.cashero.com/id/" />
      ...
      <CompaignNoEffort lang="id" focus={focus} />
      <div className="container">
        <Savings lang="id" focus={focus} />
      </div>
      {openSuccessModal && <CompaignThanksModal open={openSuccessModal} handleClose={thanksModalClose} lang="id" />}
      <CampaignTabs />
...
export default withTranslation()(PersonalCompaignID);
